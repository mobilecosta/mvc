...
FWExecView('SOLICITAÇÃO DE RECURSOS',"FBPCOA11", 3,, { || .T. } )//, , ,aButtons )
Return NIL
...
oModel:SetDescription( 'TIPO DE SOLICITAÇÃO' )
oModel:GetModel( 'PARAMETROS' ):SetDescription( 'PARAMETROS' )
oModel:GetModel( 'ZZ5DETAIL' ):SetDescription( 'DADOS DA ORIGEM' )
...
oView:CreateHorizontalBox( "BOX2",  40 )
...
oView:SetOwnerView( 'VIEW_ZZ6' , "BOX4" )
